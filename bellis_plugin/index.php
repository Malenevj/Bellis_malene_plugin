...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('bellis-style', plugin_dir_url(__FILE__).'style.css'); // Tilføjer CSS
    wp_enqueue_script('bellis-script', plugin_dir_url(__FILE__).'script.js', ['jquery'], null, true); // Tilføjer JS
});
